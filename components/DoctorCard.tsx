...
const DoctorCard: React.FC<DoctorCardProps> = ({ doctor, onClick }) => {
  return (
    <div 
      ...
      className="bg-white rounded-xl border border-slate-100 p-6 flex items-center gap-6 shadow-sm hover:shadow-xl transition-all duration-300 hover-lift group cursor-pointer"
    >
      ...
      <div className="flex-grow">
        <div className="flex items-center gap-2 mb-1">
          <h4 className="text-lg font-bold text-slate-900 leading-none serif-heading">{doctor.name}</h4>
          {doctor.isVerified && (
      ...
      <button className="p-3 text-slate-300 group-hover:text-teal-600 transition-colors">
